...
function App() {
  ...
  return <main>
    <header><div className="brand"><div className="brand-mark"><Pulse weight="bold"/></div><div><h1>Controle <span>Run</span></h1><p>PROCESS MANAGER</p></div></div><button className="root-picker" onClick={addProject}><Plus size={18}/><span><small>NOVO PROJETO</small><strong>Adicionar pasta</strong></span></button></header>
    ...
    <footer><span><i/> PM2 LOCAL</span><span>100% OFFLINE</span></footer>
